    ...
    if (validatedData.subcategory === "Laptops & Computers") {
      const product = await db.laptopComputer.create({
        data: {
          ...
          laptopSubtype: validatedData.type === "LAPTOP" && validatedData.laptopSubtype !== "" ? validatedData.laptopSubtype : undefined,
          desktopSubtype: validatedData.type === "DESKTOP" && validatedData.desktopSubtype !== "" ? validatedData.desktopSubtype : undefined,
          serverSubtype: validatedData.type === "SERVER" && validatedData.serverSubtype !== "" ? validatedData.serverSubtype : undefined,
      ...
      const product = await db.headphone.create({
        data: {
          ...
          resistance: validatedData.resistance === "" ? undefined : validatedData.resistance,
